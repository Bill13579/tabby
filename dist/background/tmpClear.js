...
/* harmony export */   "$localtmp$": () => (/* binding */ $localtmp$),
/* harmony export */   "$sync$": () => (/* binding */ $sync$),
/* harmony export */   "$synctmp$": () => (/* binding */ $synctmp$),
/* harmony export */   "StorageSpace": () => (/* binding */ StorageSpace)
/* harmony export */ });
...
"use strict";
/*!************************************!*\
  !*** ./src/background/tmpClear.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tapi_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../tapi/store */ "./src/tapi/store.js");


let tmpClear = async () => {
    console.log("[store] clearing temporary data...");
    const $localtmp$ = new _tapi_store__WEBPACK_IMPORTED_MODULE_0__.StorageSpace("local", "temp", true);
    const $synctmp$ = new _tapi_store__WEBPACK_IMPORTED_MODULE_0__.StorageSpace("sync", "temp", true);
...
/******/ })()
;
//# sourceMappingURL=tmpClear.js.map